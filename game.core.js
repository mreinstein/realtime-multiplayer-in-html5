...
function create (game_instance) {
    ...
    if (!this.server) {
        ...
        client_create_configuration(this);
        ...
        client_connect_to_server(this);

        // We start pinging the server to determine latency
        client_create_ping_timer(this);
...
function process_input (core, player ) {
...
function client_update_local_position (core) {
 if (core.client_predict) {
    ...
    //this.players.self.pos = v_add( old_state, this.v_mul_scalar( this.v_sub(current_state,old_state), t )  );
...
function client_create_configuration (core) {
    ...
    // TODO: I don't think these are used anywhere
    core.lit = 0;
